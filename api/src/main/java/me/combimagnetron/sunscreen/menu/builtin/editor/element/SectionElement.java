...
public class SectionElement extends SimpleBufferedElement {
    ...
    public Canvas canvas() {
        ...
        canvas = canvas.fill(Vec2d.of(1,1), Vec2d.of(size().x() - 2, size().y() - 2), EditorMenu.Colors.Secondary);
        canvas = canvas.fill(Vec2d.of(2,2), Vec2d.of(size().x() - 4, size().y() - 4), EditorMenu.Colors.Background);
        return canvas;
    }
