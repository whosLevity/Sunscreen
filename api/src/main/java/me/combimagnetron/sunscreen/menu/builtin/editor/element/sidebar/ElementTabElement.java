...
public class ElementTabElement extends SimpleBufferedElement {
    ...
    public ElementTabElement(Vec2d size, Identifier identifier, Position position) {
        super(size, identifier, position);
    }

    public static ElementTabElement of(Vec2d size, Identifier identifier, Position position) {
    ...
    private Canvas render() {
        ...
        result.fill(Vec2d.of(2, 2), Vec2d.of(size().x() - 4, 21), EditorMenu.Colors.Secondary);
        return result;
    }
