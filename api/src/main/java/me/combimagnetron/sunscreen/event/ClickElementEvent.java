...
public record ClickElementEvent<T extends Element>(T element, Vec2i coords, Input.Type.MouseClick click) implements Event {

    public static <T extends Element> ClickElementEvent<T> create(T element, Vec2i coords, Input.Type.MouseClick click) {
